...
text_files = sc.wholeTextFiles("hdfs://ip-172-30-0-6.eu-west-1.compute.internal:8020")
...
combine_tokenized_text = combine_tokenized_text.map(lambda x: (x[0][0], (x[0][1], x[1])))
# Term frequency RDD
